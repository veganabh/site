...
export function ActiveOrderChip() {
  ...
  return (
    <Link
      ...
      className={cn(
        "hidden items-center gap-2 rounded-pill px-3 py-1.5 text-caption font-semibold transition-colors md:inline-flex",
        copy.toneClass,
      )}
    >
      <span
      ...
      {extras > 0 && (
        <span className="ml-0.5 rounded-pill bg-paper-50/70 px-1.5 text-micro font-bold text-olive-900">
          +{extras}
        </span>
      )}
    </Link>
