      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex items-start justify-between gap-4">
          ...
          <Link
            ...
            className="inline-flex h-10 shrink-0 items-center gap-2 rounded-pill bg-olive-900 px-4 text-body-sm font-semibold text-paper-50 transition-colors hover:bg-olive-700"
          >
